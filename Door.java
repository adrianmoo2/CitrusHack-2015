...
public class Door extends Structures
{
    ...
    public void act() 
    {
        ...
        if (a!=null && Greenfoot.isKeyDown("space") && (myType == "townToBar"))
        {
        ...
        else if (a != null && Greenfoot.isKeyDown("space") && myType == "barToTown")
        {
            for (int i=0;i<doors.size();i++)
            {
                myWorld.removeObject((Actor)doors.get(i));
        ...
        else if (a!= null && Greenfoot.isKeyDown("space") && myType == "townToShop")
        {
            for (int i=0;i<doors.size();i++)
            {
                myWorld.removeObject((Actor)doors.get(i));
        ...
        else if (a!= null && Greenfoot.isKeyDown("space") && myType == "shopToTown")
        {
            for (int i=0;i<doors.size();i++)
            {
                myWorld.removeObject((Actor)doors.get(i));
